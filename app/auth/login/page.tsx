    ...
    <div className="flex h-screen w-full">
      <div className="w-full hidden md:inline-block">
        <Image
          ...
          src="/assets/images/login_side_image.png"
      ...
      <div className="w-full flex flex-col items-center justify-center p-6">
        ...
        >
          ...
          <button
            ...
            className="w-full mt-8 bg-gray-500/10 flex items-center justify-center h-12 rounded-full hover:bg-gray-500/20 transition-colors cursor-pointer"
          >
            <Image
          ...
          <div className="w-full flex items-center justify-between mt-8 text-gray-500/80">
            <div className="flex items-center gap-2">
              <input
                className="h-5 accent-brand-teal"
                type="checkbox"
                id="checkbox"
                {...register("rememberMe")}
              />
            ...
            <Link
              className="text-sm underline hover:text-brand-teal transition-colors"
          ...
          <button
            ...
            className="mt-8 w-full h-11 rounded-full text-white bg-brand-teal hover:bg-brand-teal-hover transition-colors font-medium cursor-pointer disabled:opacity-70 flex items-center justify-center"
          >
            {isSubmitting ? (
