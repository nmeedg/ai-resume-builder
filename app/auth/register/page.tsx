    ...
    <div className="flex h-screen w-full">
      <div className="w-full hidden md:inline-block">
        <Image
          ...
          src="/assets/images/register_side_image.png"
              ...
              >
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M7 8C9.20914 8 11 6.20914 11 4C11 1.79086 9.20914 0 7 0C4.79086 0 3 1.79086 3 4C3 6.20914 4.79086 8 7 8ZM0 14C0 11.7909 3.13401 10 7 10C10.866 10 14 11.7909 14 14V16H0V14Z"
                    fill="#6B7280"
                  />
                </svg>
                <input
